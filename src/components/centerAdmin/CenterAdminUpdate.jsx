...
import { singleCenterAdminQuery } from "../queries&Mutations&Functions/Queries";
...
`;
class CenterAdminUpdate extends Component {
  state = {};
...
export default CenterAdminUpdate;
