...
class CenterDetailedResults extends Component {
  state = {
    divisionID: '12',
    subDivisionID: '12',
    regionID: '12',
                                              ...
                                              return (
                                                ...
                                                >
                                                  {({ data, loading, error }) => {
                                                    ...
                                                    console.log(data);
                                                    const refinedSessions = examSessions && examSessions.map(({ __typename, ...others }) => others);
                                                    const reducedES = refinedSessions && refinedSessions.reduce((item) => item)
...
export default CenterDetailedResults;
