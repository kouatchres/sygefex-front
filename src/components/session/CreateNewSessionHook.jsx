...
const CreateNewSessionHook = () => {
    ...
    const [createSession, { loading, error }] = useMutation(createNewSessionMutation)
    return (
                    ...
                    <MinimStyledPage>
                        ...
                        <StyledForm disabled={isSubmitting} aria-busy={isSubmitting} >
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        <SygexInput name="sessionName" type="text" label="Nom Session" disabled={isSubmitting} />
                                        <SygexInput name="sessionCode" type="text" label="Code Session" disabled={isSubmitting} />
