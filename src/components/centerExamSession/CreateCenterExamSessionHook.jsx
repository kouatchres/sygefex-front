...
const CreateCenterExamSessionHook = () => {
    ...
    const [state, setState, handleReactSelectChange] = useForm({ centerNumber: "", examID: "", sessionID: "" })
    ...
    const { data: dataCenter, error: errCenter, loading: loadingCenter } = useQuery(getSingleCenterQuery, {
    ...
    const [createCenterExamSession, { loading, error }] = useMutation(createCenterExamSessionMutation)
    return (
