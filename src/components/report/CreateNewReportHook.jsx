                            ...
                            <Form>
                                <AllControls>
                                    <InputGroup>
                                        ...
                                        <SygefexSelect options={getSessionOptions} onChange={handleReactSelectChange} name="sessionID" placeholder="La session" disabled={isSubmitting} />
                                        <SygefexSelect options={getExamOptions} onChange={handleReactSelectChange} name="examID" placeholder="L'Examen" disabled={isSubmitting} />
