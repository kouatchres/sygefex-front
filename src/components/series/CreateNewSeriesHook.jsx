							...
							<Form>
								<AllControls>
									<InputGroup>
										...
										<SygefexSelect name="educType" onChange={(value) => (setFieldValue('educType', value))} options={getEducTypeOptions} placeholder={"Type d'Enseignement"} disabled={isSubmitting} />
