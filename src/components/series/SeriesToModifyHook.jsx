...
const SeriesToModifyHook = () => {
    ...
    const { data: dataSeries, loading: loadingSeries, error: errorSeries } = useQuery(getAllSeriesQuery)
    ...
    const seriesOptions = getSeries && getSeries.map((item) => (
                        ...
                        <Form>
                            <AllControls>
                                <TwoGroups>
                                    ...
                                    <InputGroup>
                                        <SygefexSelect name="seriesID" onChange={handleReactSelectChange} options={seriesOptions} placeholder={"La Séries "} />
                                    </InputGroup>
                                    <Buttons>
                                        <ButtonStyled>

                                            <StyledButton type="submit" id={state.seriesID}>Supprimer</StyledButton>
                                        </ButtonStyled>
                                        <ButtonStyled>
