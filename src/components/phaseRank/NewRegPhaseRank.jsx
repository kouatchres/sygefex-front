                                ...
                                <Form>
                                  <AllControls>
                                    <InputGroup>
                                      ...
                                      <SygefexSelect name="phase" onChange={(value) => (setFieldValue('phase', value))} options={getPhases} placeholder={"La Phase de l'Examen"} />

                                      <SygefexSelect name="rank" onChange={(value) => (setFieldValue('rank', value))} options={getRanks} placeholder={"Poste de responsabilité tenu"} />
