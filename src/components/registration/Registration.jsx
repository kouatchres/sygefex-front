                                                                                                                                ...
                                                                                                                                return (
                                                                                                                                    <Query query={getCenterExamSessionSeriesQuery}
                                                                                                                                        variables={{
                                                                                                                                            ...
                                                                                                                                            centerExamSession: getObj
                                                                                                                                        }}
                                                                                                                                    >
                                                                                                                                        {({ data, error, loading }) => {
                                                                                                                                            console.log(data)
                                                                                                                                            const { centerExamSessionSerieses } = { ...data }
                                                                                                                                            const refinedCenterExamSessionSeries = centerExamSessionSerieses && centerExamSessionSerieses.map(({
                                                                                                                                                __typename,
                                                                                                                                                ...others
                                                                                                                                            }) => others);
                                                                                                                                            const getCESSObj = refinedCenterExamSessionSeries && refinedCenterExamSessionSeries.reduce((item) => item);
                                                                                                                                            console.log(getCESSObj);
