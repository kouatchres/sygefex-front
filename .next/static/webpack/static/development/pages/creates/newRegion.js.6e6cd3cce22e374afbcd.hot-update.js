...
/* harmony import */ var _Filters__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Filters */ "./src/components/region/Filters.jsx");
...
var RegionsList = function RegionsList() {
  ...
  var client = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_6__["useApolloClient"])();
  ...
  var columns = Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])(function () {
    return [{
      ...
      columns: [{
        ...
        accessor: "regName",
        disableSortBy: true,
        Filter: _Filters__WEBPACK_IMPORTED_MODULE_7__["SelectColumnFilter"],
        filter: "equals"
      }, {
        Header: "Code Region ",
        accessor: "regCode"
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_TableContainer__WEBPACK_IMPORTED_MODULE_2__["default"], {
    columns: columns,
    data: data,
    __source: {
...
//# sourceMappingURL=newRegion.js.6e6cd3cce22e374afbcd.hot-update.js.map